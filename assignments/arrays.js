...
const findCar = inventory.find(inventory => inventory.id === 33);
...
// console.log(`The make is ${lastCar.car_make}. The model is ${lastCar.car_model}`);
...
let oldCars = [];
oldCars = carYears.filter(car_year => car_year < 2000).length;
